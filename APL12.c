...
//Add Kunde to Liste
void kunde_push(kunde **all, int counter) {
	kunde *top = (kunde*)malloc(sizeof(kunde));
	if (!top){
		print("stack_push: out of memory\n");
		return;
	}
...
int main(void) {
	...
	kunde *List = NULL; //Liste initialisieren
