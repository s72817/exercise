...
int main(void) {
	...
	do
	{
		...
		printf("4: Auszahlung\n");
		printf("5: Kontostand\n");
		printf("6: 4-stellige Pin aendern\n");
		printf("7: Kundendaten anzeigen\n");
		printf("8: Abmelden\n");
		printf("9: Beenden\n");
	...
	} while (menuezahl != 9); //Ende der Schleife bei Eingabe der Zahl 8
